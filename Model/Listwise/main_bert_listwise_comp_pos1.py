...
parser.add_argument("--output_dir",default='./bert_listwise_relall_main_type_entity_time_ordinal_rank_pos1_before_' + str(N) + '_1_' + str(steps_num) + '/',type=str)
...
# parser.add_argument("--v_file_name",default='compq_classify_neg_' + str(1000000) + '_dev_all_is_rank.txt',type=str)
# parser.add_argument("--t_file_name",default='compq_classify_neg_' + str(1000000) + '_test_all_is_rank.txt',type=str)
# parser.add_argument("--T_file_name",default='compq_listwise_top_' + str(N) + '_is_train.txt',type=str)
# parser.add_argument("--v_file_name",default='compq_classify_neg_' + str(1000000) + '_is_dev_all.txt',type=str)
# parser.add_argument("--t_file_name",default='compq_classify_neg_' + str(1000000) + '_is_test_all.txt',type=str)
# parser.add_argument("--T_file_name",default='compq_listwise_top_50_allrel1_is_train.txt',type=str)
# parser.add_argument("--v_file_name",default='compq_classify_neg_50_is_allrel1dev_all.txt',type=str)
# parser.add_argument("--t_file_name",default='compq_classify_neg_50_is_allrel1test_all.txt',type=str)
# parser.add_argument("--T_file_name",default='compq_listwise_new_search_top_50_relall_main_type_entity_time_ordinal_before_is_train.txt',type=str)
# parser.add_argument("--T_file_name",default='compq_listwise_top_50_relall_main_type_entity_time_ordinal_before_is_train.txt',type=str)
# parser.add_argument("--v_file_name",default='compq_listwise_top_50_relall_main_type_entity_time_ordinal_before_dev_all.txt',type=str)
# parser.add_argument("--t_file_name",default='compq_listwise_top_50_relall_main_type_entity_time_ordinal_before_test_all.txt',type=str)

parser.add_argument("--T_file_name",default='compq_listwise_top_50_relall_main_type_entity_time_ordinal_rank_before_is_train.txt',type=str)
...
# parser.add_argument("--t_file_name",default='compq_listwise_top_50_relall_main_type_entity_timestr_before_test_all.txt',type=str)

# parser.add_argument("--T_file_name",default='compq_listwise_new_search_top_50_relall_onlymain_is_train.txt',type=str)
# # parser.add_argument("--T_file_name",default='compq_listwise_top_50_relall_onlymain_is_train.txt',type=str)
# parser.add_argument("--v_file_name",default='compq_listwise_top_50_relall_onlymain_dev_all.txt',type=str)
# parser.add_argument("--t_file_name",default='compq_listwise_top_50_relall_onlymain_test_all.txt',type=str)
...
def convert_examples_to_features(examples, label_list, max_seq_length,
    ...
    for (ex_index, example_group) in enumerate(examples):
        ...
        for example in example_group:
            ...
            if output_mode == "classification" or output_mode == "listwise":
                        ...
                        for j, item in enumerate(que_item):
                            if(label_ids_que[i][j] == 0):
                                if(item != 1):
                                    ...
                                    # loss_list.append(torch.log(1 - item))
                            else:
                                flag = 1
                                if(item > que_item[k]):
                                    k = j
                                # if(item != 0):
                                #     loss += torch.log(item)
                                    # loss_list.append(torch.log(item))
                                # import pdb; pdb.set_trace()
                        if(flag == 1):
                            if(logits_que[i][k] != 0):
                                loss += torch.log(logits_que[i][k])
                    loss = 0 - loss
                    # import pdb; pdb.set_trace()
                    # 计算评价函数
