...
parser.add_argument("--output_dir",default='./bert_listwise_seed10000_top_relall_main_rel1_type_entity_time_ordinal_before_is_1_' + str(N) + '_1_100/',type=str)
parser.add_argument("--input_model_dir", default='0.9675389502344577_0.4803025192052977_3', type=str)
parser.add_argument("--T_file_name",default='webq_listwise_1_40_relall_main_rel1_type_entity_time_ordinal_before_isis_train.txt',type=str)
parser.add_argument("--v_file_name",default='webq_listwise_1_30_relall_main_rel1_type_entity_time_ordinal_before_isdev_all.txt',type=str)
parser.add_argument("--t_file_name",default='webq_listwise_1_30_relall_main_rel1_type_entity_time_ordinal_before_istest_all.txt',type=str)
# parser.add_argument("--T_file_name",default='webq_listwise_random_top_20_relall_onlymain_is_train.txt',type=str)
# parser.add_argument("--v_file_name",default='webq_listwise_random_top_20_relall_onlymain_dev_all.txt',type=str)
# parser.add_argument("--t_file_name",default='webq_listwise_random_top_20_relall_onlymain_test_all.txt',type=str)
...
parser.add_argument('--gradient_accumulation_steps',type=int,default=100,help="Number of updates steps to accumulate before performing a backward/update pass.")
    ...
    if args.do_train:   
        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            if args.do_eval:
                ...
                f_valid.flush()
                P_dev = cal_f1(file_name1, args.data_dir + args.v_file_name, 'v', actual_num=0)
            if(True):
...
def test(best_model_dir_name):
    ...
    if args.do_eval:
        ...
        f.flush()
        cal_f1(file_name1, args.data_dir + args.t_file_name, 't', actual_num=0)
