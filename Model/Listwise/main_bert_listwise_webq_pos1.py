...
parser.add_argument("--output_dir",default='./bert_listwise_top_relall_main_rel1_type_entity_time_ordinal_before_is_posloss1_' + str(N) + '_1_100/',type=str)
parser.add_argument("--input_model_dir", default='0.9675389502344577_0.4803025192052977_3', type=str)
parser.add_argument("--T_file_name",default='webq_listwise_random_top_40_relall_main_rel1_type_entity_time_ordinal_before_isis_train.txt',type=str)
parser.add_argument("--v_file_name",default='webq_listwise_random_top_40_relall_main_rel1_type_entity_time_ordinal_before_isdev_all.txt',type=str)
parser.add_argument("--t_file_name",default='webq_listwise_random_top_40_relall_main_rel1_type_entity_time_ordinal_before_istest_all.txt',type=str)
