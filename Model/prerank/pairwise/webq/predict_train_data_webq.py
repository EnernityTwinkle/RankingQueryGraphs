...
if __name__ == "__main__":
    ...
    dirName = BASE_DIR + '/runnings/model/webq/pairwise/'
    ...
    model2file = {'bert_webq_pairwise_40_5372/0.8961438008910739_0.5530888822244706_3':'webq_with_answer_info_train_all.txt'}
