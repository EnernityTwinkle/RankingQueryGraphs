...
if __name__ == "__main__":
    ...
    # client = WatchClient(id="webq_mergexx5", gpus=[5],
    ...
    for seed in [42]:
        for steps in[100]:
            ...
            # for N in [5, 10, 20]:
                ...
                parser.add_argument("--output_dir",default='../../../bert_rank_data/model/webq/bert_webq_pointwise_true1_gradual_merge_type_entity_time_ordianl_mainpath_neg_' + str(N) + '_' + str(seed) + '_' + str(steps) + '/',type=str)
