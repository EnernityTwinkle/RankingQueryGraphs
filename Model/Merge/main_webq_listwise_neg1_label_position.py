        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
                ...
                if 'listwise' in merge_mode:
                    ...
                    neg_score = logits_que[:, 1:].sort(descending=True)[1]
                    ...
                    for i, que_item in enumerate(logits_que):
                        ...
                        if(flag == 1):
                            for neg_i in range(neg_num):
                                if(logits_que[i][neg_score[i][neg_i] + 1] != 1):
                                    loss_list += torch.log(1 - logits_que[i][neg_score[i][neg_i] + 1])
...
if __name__ == "__main__":
    ...
    # client = WatchClient(id="webq_mergex3" + str(N) + str(seed) + str(steps), gpus=[3],
    ...
    for seed in [42]:
        for steps in[100]:
            ...
            # for N in [80, 100, 120, 140]:
                ...
                parser.add_argument("--output_dir",default='../../../bert_rank_data/model/webq/bert_webq_listwise_true1_neg1_gradual_merge_type_entity_time_ordianl_mainpath_neg_' + str(N) + '_' + str(seed) + '_' + str(steps) + '/',type=str)
                ...
                parser.add_argument("--T_file_name",default='webq_rank1_f01_true1_gradual_label_position_listwise_1_' + str(N) + '_type_entity_time_ordinal_mainpath_is_train.txt',type=str)
