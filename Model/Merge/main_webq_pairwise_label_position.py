...
if __name__ == "__main__":
    ...
    for seed in [42]:
        for steps in[100]:
            ...
            # for N in [5, 10, 20, 80, 100, 120]:
                steps = int(800 / N)
                logger = logging.getLogger(__name__)
                # from watchmen import WatchClient
                # client = WatchClient(id="webq_merge5" + str(N) + str(seed) + str(steps), gpus=[5],
                ...
                parser.add_argument("--output_dir",default='../../../bert_rank_data/model/webq/bert_webq_800_pairwise_true1_gradual_merge_type_entity_time_ordianl_mainpath_neg_' + str(N) + '_' + str(seed) + '_' + str(steps) + '/',type=str)
