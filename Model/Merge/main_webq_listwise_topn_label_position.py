            ...
            for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
                ...
                if 'listwise' in merge_mode:
                    ...
                    for i, que_item in enumerate(logits_que):
                        ...
                        if(flag == 1):
                            if(logits_que[i][k] != 0):
                                loss_list += torch.log(logits_que[i][k])
    ...
    for seed in [42]:
        for steps in[100]:
            ...
            # for N in [80, 100, 120, 140]:
                ...
                parser.add_argument("--output_dir",default='../../../bert_rank_data/model/webq/bert_topn_posloss1_gradual_merge_type_entity_time_ordianl_mainpath_neg_' + str(N) + '_' + str(seed) + '_' + str(steps) + '/',type=str)
                ...
                parser.add_argument("--T_file_name",default='webq_topn_gradual_label_position_listwise_1_' + str(N) + '_type_entity_time_ordinal_mainpath_is_train.txt',type=str)
                parser.add_argument("--v_file_name",default='webq_rank1_f01_gradual_label_position_listwise_1_140_type_entity_time_ordinal_mainpath_dev_all.txt',type=str)
                parser.add_argument("--t_file_name",default='webq_rank1_f01_gradual_label_position_listwise_1_140_type_entity_time_ordinal_mainpath_test_all.txt',type=str)
