    ...
    for seed in [42]:
        for steps in[100]:
            ...
            for N in [5]:
                ...
                parser.add_argument("--output_dir",default='../../../bert_rank_data/model/compq/bert2_compq_rank1_f01_true1_gradual_listwise_merge_type_entity_time_ordianl_mainpath_neg_' + str(N) + '_' + str(seed) + '_' + str(steps) + '/',type=str)
