...
sys.path.append('../')
from cal_f1 import cal_f1, cal_f1_with_scores
import pickle
import shutil
...
# client = WatchClient(id="webq_pairwisexxxy" + str(NEG), gpus=[4],
...
parser.add_argument("--data_dir",default='../../Build_Data/CompQ_data/',type=str)
...
# parser.add_argument("--output_dir",default='./compq_train_model/comp_new_search_bert_pairwise_1_neg' + str(NEG) + '_16_50/',type=str)
# parser.add_argument("--output_dir",default='./compq_train_model/comp_bert_pairwise_10epoch_1_neg' + str(NEG) + '_16_50/',type=str)
# parser.add_argument("--output_dir",default='./compq_train_model/comp_bert_4constrain_after_pairwise_1_neg' + str(NEG) + '_16_50/',type=str)
parser.add_argument("--output_dir",default='./compq_train_model/comp_bert_time_constrain_mainpath_pairwise_1_neg' + str(NEG) + '_16_50/',type=str)
parser.add_argument("--input_model_dir", default='0.9675389502344577_0.4803025192052977_3', type=str)
# parser.add_argument("--T_file_name",default='compq_pairwise_neg_40_is_relall_main_type_entity_time_ordinal_before_is__train_all.txt',type=str)
# # parser.add_argument("--T_file_name",default='compq_new_search_pairwise_neg_20_is_relall_main_type_entity_time_ordinal_before_is__train_all.txt',type=str)
# parser.add_argument("--v_file_name",default='compq_pairwise_neg_30_is_relall_main_type_entity_time_ordinal_before_is_dev_all.txt',type=str)
# parser.add_argument("--t_file_name",default='compq_pairwise_neg_30_is_relall_main_type_entity_time_ordinal_before_is_test_all.txt',type=str)

# parser.add_argument("--T_file_name",default='compq_pairwise_neg_40_is_relall_main_type_entity_time_ordinal_after_is__train_all.txt',type=str)
# parser.add_argument("--v_file_name",default='compq_pairwise_neg_40_is_relall_main_type_entity_time_ordinal_after_is_dev_all.txt',type=str)
# parser.add_argument("--t_file_name",default='compq_pairwise_neg_40_is_relall_main_type_entity_time_ordinal_after_is_test_all.txt',type=str)
# 只用type约束
parser.add_argument("--T_file_name",default='compq_pairwise_neg_40time_constrain_entity_rel_answer__train_all.txt',type=str)
parser.add_argument("--v_file_name",default='compq_pairwise_neg_40type_entity_time_ordinal_constrain_entity_rel_answer_dev_all.txt',type=str)
parser.add_argument("--t_file_name",default='compq_pairwise_neg_40type_entity_time_ordinal_constrain_entity_rel_answer_test_all.txt',type=str)

# type约束和实体约束
# parser.add_argument("--T_file_name",default='compq_pairwise_neg_40_entity_rel_answer_is__train_all.txt',type=str)
# parser.add_argument("--v_file_name",default='compq_pairwise_neg_40_relall_main_is_dev_all.txt',type=str)
# parser.add_argument("--t_file_name",default='compq_pairwise_neg_40_relall_main_is_test_all.txt',type=str)
...
# parser.add_argument('--seed',type=int,default=10000,help="random seed for initialization")
parser.add_argument('--gradient_accumulation_steps',type=int,default=25,help="Number of updates steps to accumulate before performing a backward/update pass.")
...
def convert_examples_to_features(examples, label_list, max_seq_length,
    ...
    for (ex_index, example_group) in enumerate(examples):
        ...
        for example in example_group:
            ...
            if output_mode == "classification" or output_mode == "listwise" or output_mode == 'pairwise':
...
def main(fout_res):
    ...
    if(output_modes['mrpc'] == 'listwise' or output_modes['mrpc'] == 'pairwise'):
        num_labels = 1
    ...
    if args.do_train:   
        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            if args.do_eval:
                ...
                f_valid.flush()
                p, r, F_dev = cal_f1(file_name1, args.data_dir + args.v_file_name, 'v', actual_num=300)
...
def test(best_model_dir_name, fout_res):
    ...
    if args.do_eval:
        ...
        f.flush()
        p, r, f = cal_f1(file_name1, args.data_dir + args.t_file_name, 't', actual_num=800)
        fout_res.write(str(p) + '\t' + str(r) + '\t' + str(f) + '\n')
