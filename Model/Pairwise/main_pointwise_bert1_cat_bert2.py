...
if __name__ == "__main__":
    ...
    for N in [5]:
        ...
        parser.add_argument("--output_dir",default=BASE_DIR + '/runnings/model/webq/bert_group1_webq_pointwise_two_sentence_catsub_dense_activate_neg_' + str(N) + '_' + str(seed) + '_' + str(steps) + '/',type=str)
