...
if __name__ == "__main__":
    ...
    for N in [40, 50, 60, 70, 80, 90, 100, 110, 120]:
        ...
        parser.add_argument("--output_dir",default=BASE_DIR + '/runnings/model/compq/compq_rerank_2bert_answer_type_pointwise_to2add_neg_' + str(N) + '_' + str(seed) + '_' + str(steps) + '/',type=str)
