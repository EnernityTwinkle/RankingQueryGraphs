...
if __name__ == "__main__":
    ...
    # file_name = './webq_classify_neg_' + str(NEG_NUM) + '_relall_main_type_entity_time_ordianl_is_rank'
    ...
    # qid2question = pickle.load(f)
    # qid2cands_train, qid2cands_dev, qid2cands_test = split_data_webq(qid2cands)
    # file_name = './webq_classify_neg_' + str(NEG_NUM) + '_type_entity_time_ordinal_mainpath_'
    # # file_name = '/data2/yhjia/kbqa_train_data/WebQ/pointwise/webq_classify_neg_' + str(NEG_NUM) + '_type_entity_time_ordinal_mainpath_'
    ...
    qid2question = pickle.load(f)
    qid2cands_train, qid2cands_dev, qid2cands_test = split_data_webq(qid2cands)
    file_name = './webq_label_position_classify_neg_' + str(NEG_NUM) + '_type_entity_time_ordinal_mainpath_'
    # file_name = '/data2/yhjia/kbqa_train_data/WebQ/pointwise/webq_classify_neg_' + str(NEG_NUM) + '_type_entity_time_ordinal_mainpath_'
    train_data = select_classify_data_solid(qid2question, qid2cands_train, pos_only1=False, data_type='T', neg=NEG_NUM)
